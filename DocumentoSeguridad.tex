...
\begin{supertabular}{|p{3cm}|p{11cm}|}
	\hline
	\multicolumn{2}{|>{\columncolor[rgb]{0.8,0.8,0.8}}c|}{\textbf{SOPORTE}}\\
	\hline
	Identificación &  \\
	\hline
	Contenido & \\
...
\begin{supertabular}{|p{3cm}|p{11cm}|}
	\hline
	\multicolumn{2}{|>{\columncolor[rgb]{0.8,0.8,0.8}}c|}{\textbf{FINALIDAD Y DESTINO}}\\
	\hline
	Finalidad &  \\
	\hline
	Destino & \\
...
\begin{supertabular}{|p{3cm}|p{11cm}|}
	\hline
	\multicolumn{2}{|>{\columncolor[rgb]{0.8,0.8,0.8}}c|}{\textbf{FORMA DE ENVÍO}}\\
	\hline
	Medio de envío &  \\
	\hline
	Remitente & \\
...
\begin{supertabular}{|p{3cm}|p{11cm}|}
	\hline
	\multicolumn{2}{|>{\columncolor[rgb]{0.8,0.8,0.8}}c|}{\textbf{AUTORIZACIÓN}}\\
	\hline
...
\vspace{-0.6cm}
\bottomcaption{Inventario de soportes}
\begin{center}
\begin{supertabular}{|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|}
	\hline 
	\multicolumn{7}{|>{\columncolor[rgb]{0.8,0.8,0.8}}c|}{\textbf{INVENTARIO DE SOPORTES}}\\
	\hline
	& \multicolumn {3}{|c|}{\textbf{ALTAS}} & \multicolumn {3}{|c|}{\textbf{BAJAS}} \\
	\cline{2-7}
	\multicolumn {1}{|c|}{Soporte} & & \multicolumn {1}{|c|}{Fecha} & \multicolumn {3}{|c|}{Motivo} & \\
	\cline{4-6}
	& \multicolumn {1}{|c|}{Nº de orden} & \multicolumn {1}{|c|}{de copia} & \multicolumn {1}{|c|}{\small Reutilización} & \multicolumn {1}{|c|}{\small Destrucción} & \multicolumn {1}{|c|}{\small Otros} & \multicolumn {1}{|c|}{Fecha} \\
	\hline
	 & & & & & & \\
	\hline
	 & & & & & & \\
