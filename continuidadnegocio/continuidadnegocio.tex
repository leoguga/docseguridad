...
Cubren amenazas de desastres naturales (N.1, N.2), de origen industrial (I.1-I.7, I.11), errores y fallos no intencionados (E.1,E.2, E.8, E.15, E.17, E.18), ataques intencionados (A.4, A.8, A.11, A.15-A.18, A.22, A.25-A.27, A.29). Se debe tener en cuenta que están enfocadas a una futura recuperación de los datos del sistema (o parte de este), por lo que el proceso de copias debe ser confiable. Así como asegurar que si hiciese falta una recuperación, esta fuese rápida y eficiente.
