%descripción: un artículo con márgenes más anchos, 
...
\setlength{\textwidth}{6.3in}    % width of text
\setlength{\oddsidemargin}{-0.08in} % odd page left margin
\setlength{\evensidemargin}{-0.08in} % even page left margin
\usepackage[cp1252]{inputenc}
\usepackage[spanish]{babel}
\title{Seguridad y Competencias Profesionales
\\Curso 2010/2011}
\author{Rafael, Ledia, Leopoldo, Jesus, Luis}
% Document
\begin{document}
\maketitle
...
\begin{figure}
	\centering	\includegraphics{C:/Varios/casa/Academico/SeguridadCompetenciaProfesionales/Trabajo/DisegnoRed/diagramared.jpg}
	\label{Arquitectura red}
\end{figure}

\subsection{\textbf{Seguridad}}
\paragraph{}
